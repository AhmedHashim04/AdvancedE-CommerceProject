    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flash_sale', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='promotions.flashsale')),
                ('color_options', models.ManyToManyField(blank=True, to='store.productcolor')),
                ('gallery', models.ManyToManyField(blank=True, to='store.productimage')),
                ('shipping_class', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='store.shippingclass')),
