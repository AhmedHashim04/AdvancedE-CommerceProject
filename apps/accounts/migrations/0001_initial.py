    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(blank=True, help_text='State or City (optional)', max_length=100, null=True, verbose_name='State or City')),
                ('village', models.CharField(blank=True, help_text='Village (optional)', max_length=100, null=True, verbose_name='Village')),
                ('address_line1', models.CharField(help_text='Write detailed address that you want to deliver the order ', max_length=255, verbose_name='Address Line 1')),
