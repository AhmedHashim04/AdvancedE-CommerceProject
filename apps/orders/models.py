...
# from cart.cart import Addition_Shipping_Cost
...
#     shipping_option = models.ForeignKey("ShippingOption",on_delete=models.PROTECT,related_name="orders",verbose_name=_("Shipping Option"))
