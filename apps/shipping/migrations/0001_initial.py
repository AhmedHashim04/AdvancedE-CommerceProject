    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('company_address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='shipping.address', verbose_name='Address')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('min_weight', models.DecimalField(blank=True, decimal_places=2, help_text='Minimum weight in kg, null if not applicable', max_digits=10, null=True, verbose_name='Minimum Weight (kg)')),
                ('price_per_kilo', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Price per Kilo (EGP)')),
                ('plan', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='weight_pricing', to='shipping.shippingplan')),
            ],
            options={
                'verbose_name': 'Weight Pricing',
                'verbose_name_plural': 'Weight Pricing',
                'ordering': ['min_weight'],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('volume', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Volume (cm³)')),
